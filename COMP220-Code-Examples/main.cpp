...
int main(int argc, char ** argsv)
{
	...
	GLuint ambientLightColorLocation = glGetUniformLocation(programID, "ambientLightColor");
	GLuint ambientMaterialColorLocation = glGetUniformLocation(programID, "ambientMaterialColor");
	...
	glm::vec4 ambientMaterialColor = glm::vec4(0.2f, 0.2f, 0.2f, 1.0f);
